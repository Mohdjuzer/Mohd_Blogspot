...
<x-input-error :messages="$errors->get('image')" class="mt-2" />
            ...
            <x-text-input id="title" class="block p-2 mt-1 w-full" type="title" name="title" :value="old('title')" />
         ...
         <div class="mt-4">
            ...
            <x-text-inputarea id="content" class="block mt-1 w-full" name="content">{{ old('content') }}</x-text-inputarea>
